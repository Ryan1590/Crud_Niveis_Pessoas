...
<body>
    ...
    <h1 class="text-center mt-4">@if(isset($devs)) Editar @else Cadastro @endif</h1>


    <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Desenvolvedor</h3>
            </div>
            @if(isset($devs))
            <form action="{{ route('desenvolvedores.update', $devs->id) }}" method="post" name="formEdit" id="formEdit" class="p-4 border shadow rounded">
                ...
                <form action="{{ route('desenvolvedores.store') }}" method="post" name="formCard" id="formCard" class="p-4 border shadow rounded">
                    ...
                    <div class="form-group d-flex justify-content-between">
                        <button type="submit" class="btn btn-primary">@if(isset($devs)) Editar @else Cadastrar @endif</button>
